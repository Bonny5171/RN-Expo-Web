          ...
          <View style={styleFPU.filterPopUp}>
            ...
            <Row style={styleFPU.bodyRow}>
              <View>
                ...
                <View style={[global.vwIT, { width: 590 }]}>
                  <TextInput
              ...
              <DropDown
                name="dropSituacao"
                width={267}
                labelStyle={{ marginLeft: styleFPU.bodyRow.paddingLeft }}
                vwStyle={{ marginLeft: styleFPU.bodyRow.paddingLeft }}
            ...
            <Row style={styleFPU.bodyRow}>
              ...
              />
              <View style={{ marginLeft: styleFPU.bodyRow.paddingLeft }}>
                ...
                <Row style={{ alignItems: 'center', marginTop: -0.5 }}>
                  ...
                  <View style={[global.vwIT, { width: 140, marginLeft: 14 }]}>
                    <TextInput
                      underlineColorAndroid="transparent"
                      style={global.txtInput}
                      onChangeText={(de) => {
